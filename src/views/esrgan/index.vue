<template>
  <div>
    <h1 style="text-align: center">Esrgan超分辨率处理</h1>

    <div>
      <el-form ref="form"  style="padding: 10px" :inline="true">

        <el-form-item >
          <el-button type="warning" @click="triggerFileInput">选择图片</el-button>
          <input type="file" @change="uploadFile" accept="image/*" style="display: none" ref="fileInput">
        </el-form-item>
        <br>


        <el-form-item label="超分辨率倍数:">
        ...
        <el-form-item label="Alpha 值:">
          <el-input-number v-model="requestParams.alpha" :min="0.7" :max="1.3" :step="0.1"></el-input-number>
        </el-form-item>

        <br>
        <el-form-item>
          <el-button type="primary" @click="performSuperResolution">开始处理</el-button>
          <el-button @click="resetRequestParams">重置参数</el-button>
        </el-form-item>
      </el-form>
